...
import EinvoicePolicy from '../views/EinvoicePolicy.vue';
...
const routes: Array<RouteConfig> = [
    ...
    {
        path: '/redeem-promotion/:promotionId',
...

    {
        path: '/website-owners',
        name: 'WebsiteOwner',
        component: WebsiteOwner,
        meta: {
            keepAlive: false
        }
    },
    {
        path: '/general-trading-conditions',
        name: 'GeneralTradingConditions',
        component: GeneralTradingConditions,
        meta: {
            keepAlive: false
        }
    },
